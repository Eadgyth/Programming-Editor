...
<h4>LIMITATIONS</h4>
<ul>
<li>Syntax highlighting is simple (coloring of keywords, sigils, tags, string literals, line and block comments) and supports Java, C#, Pythyon, R, HTML, XML, PHP CSS and JavaScript. While generally performant, opening or closing multiline string litererals can cause noticeable delays. The syntax highlighting is part of this editor and not meant as an example of how it should be done at the code level.</li>
<li>The dark backgrounds are applied to the main window only. The main menu bar with System L&F and title bar remain system dependent. Menus, dialogs et cetera are so far excluded.</li>
