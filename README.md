...
<li>To compile Java code by the built-in compile function, the editor must be run with the JRE contained in a JDK.</li>
<li>To run C#, Python, or R, the executable paths must be present in your system PATH. To compile and run C# code, the editor internally uses the .NET SDK.</li>
...
<li>The dark-blue background theme uses the <a href="https://github.com/dracula/dracula-theme">Dracula Colors</a> and colors for the other dark backgrounds were defined starting with these colors.</li>
</ul>
<h4>LICENSE</h4>
<p>
MIT, see LICENSE<br>
