...
public class Lexer {
   ...
   /**
    * Controls multiline corrections when coloring is done by
    * {@link #colorLine(String, int)}, particularly the uncommenting of
    * block comments
    *
    ...
    * be colored starts
    */
   public void colorAll(String allText, int posStart) {
      colorable.color(allText, allText, 0, posStart, this);
   }
   
    /**
    * Colors the current line where a change happened (the entire text is 
    * yet scanned for block comments).
    * <p>
    * Calls {@link Colorable #color(String,String,int,int,this)}
    *
    * @param allText  the entire text of the document
   ...
   public void stringLiterals(String toColor, int pos, String blockStart,
      ...
      if (!isTypeMode && Finder.countMotif(toColor, "\n") > 1) {
         //
