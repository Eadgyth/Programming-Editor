...
<p>If you give the editor a try, I would be grateful for comments via the GitHub Issues page. I think, the editor is best suited for personal use when a full IDE is not required. The goal is to provide an easy setup to try out your own code, while maintaining enough flexibility to use it for real coding projects.</p>
<br>
<h4>Features for editing text are ...</h4>
<ul>
<li>Find/replace (where also "replace all" is undoable/redoable)</li>
<li>Clearing end-of-line (trailing) white spaces in a whole dicument or current line.</li>
...
<li>A dockable 'notes' editor next to the main editor with shortcuts to exchange text.</li>
...
<br><br>
<img src="images/SimpleInteractivePyExample.png" width="700"/><br><br>
<img src="images/EditorWithNotesPanelExample.png" width="700"/><br><br>
<img src="images/SettingsDialogExample.png" width="700"/><br><br>
<img src="images/RunJavaModuleWithDepExample.png" width="700"/><br><br>
